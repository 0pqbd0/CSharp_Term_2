...
[Bubble sort](https://github.com/0pqbd0/CSharp_Term_2/tree/main/BubbleSort)
<details>
<summary>Условие</summary>
Реализовать сортировку пузырьком
</details>

[Stack calculator](https://github.com/0pqbd0/CSharp_Term_2/tree/main/StackCalculator)
<details>
<summary>Условие</summary>
Реализовать cтековый калькулятор (класс, реализующий выполнение операций `+`, `-`, `*`, `/` над арифметическим выражением в виде строки в постфиксной записи)
...
[Unique list](https://github.com/0pqbd0/CSharp_Term_2/tree/main/UniqueList)
<details>
<summary>Условие</summary>
Реализовать класс cписок с методами добавления, удаления и изменения элемента по позиции, и, унаследовавшись от него, реализовать класс `UniqueList`, который не содержит повторяющихся значений. Реализовать классы исключений, которые генерируются при попытке добавления в такой список уже существующего или при попытке удаления несуществующего элемента.
</details>

[Routers](https://github.com/0pqbd0/CSharp_Term_2/tree/main/Routers)
<details>
<summary>Условие</summary>
...
[Functional methods (Map, Filter, Fold)](https://github.com/0pqbd0/CSharp_Term_2/tree/main/FunctionalMethods)
<details>
<summary>Условие</summary>
...
[Calculator with UI](https://github.com/0pqbd0/CSharp_Term_2/tree/main/Calculator)
<details>
<summary>Условие</summary>
